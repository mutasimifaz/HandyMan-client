  ...
  return (
    <tr className="bg-white">
      ...
      <td className="flex items-center justify-center">
        {role !== "admin" ? (
          <button
            className="fal fa-user-plus text-center text-green-600"
            onClick={makeAdmin}
          ></button>
        ) : (
          <button
            className="fal fa-user-slash text-center  text-red-600"
            onClick={makeUser}
          ></button>
        )}
      </td>
      <div className="flex items-center justify-center bg-white">
        <label
          ...
          className="fal fa-trash-arrow-up text-red-600  cursor-pointer text-center"
        ></label>
      </div>
    </tr>
  );
