                    ...
                    <div className="border-b border-gray-200">
                        <div className="h-16 flex items-center">
                            ...
                            <div className="ml-4 flex lg:ml-0">
                                <Link to="/">
                                    ...
                                    <img
                                        ...
                                        src="https://i.ibb.co/TYRjqyz/1600w-i-a-Xu-en-Vtw-removebg-preview.png"
                                        alt=""
                                    />
                                </Link>
                            </div>
                            ...
                            <div className="ml-auto flex items-center">
                                ...
                                {location.pathname==='/dashboard'?<label htmlFor="dashboard-sidebar" className="px-3 py-2 rounded lg:hidden"><i className="fal fa-bars-sort text-xl font-medium text-gray-400"></i></label>:null}
