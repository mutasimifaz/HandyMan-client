...
const Purchase = () => {
    ...
    fetch("https://handyman-server-production.up.railway.app/order", {
      ...
      .then((data) => {
        if (data.success) {
          ...
          toast.error(
            `Can't confirm order at. Please try again, ${currentDate}`
          );
        }
      });
  };
  ...
  return (
    <div>
        ...
        <div className="pt-6">
          ...
          <div className="mt-6 max-w-2xl mx-auto sm:px-6 lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-2 lg:gap-x-8">
            <div
              ...
              className="aspect-w-4 aspect-h-5 sm:rounded-lg sm:overflow-hidden lg:aspect-w-3 lg:aspect-h-4 object-center flex items-center justify-center"
            >
              <img
                src={tool?.image}
                alt={tool?.name}
                className="object-center object-contain  flex items-center justify-center p-20"
              />
            </div>
                  ...
                  <form onSubmit={handleOrder}>
                    <div className="mb-6">
                      ...
                      <input
                        ...
                        type="text"
                        value={currentDate}
                        className="bg-gray-400 cursor-not-allowed select-none border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                      />
                    </div>
                    <div className="mb-6">
                      <label
      ...
      {/* <Reviews toolId={tool?._id}/> */}
      <ProductReviews toolId={tool?._id} />
    </div>
  );
};
