...
const Contact = () => {
  ...
  <div className="form-group mb-6">
      <label for="exampleInputPassword1" className="form-label inline-block mb-2 text-gray-700">Your Name</label>
    ...
    <div className="form-group mb-6">
      <label for="exampleInputPassword1" className="form-label inline-block mb-2 text-gray-700">Query</label>
    ...
    <input required={true} type="checkbox" className="checkbox h-3 w-3 mr-2 checkbox-primary" />
      ...
      <label className="form-check-label inline-block text-gray-800" for="exampleCheck1">Are you agreed to terms and conditions?</label>
    </div>
