...
const SignUp = () => {
    ...
    if (error || gError || updateError) {
        signInError = <p className='text-red-400 text-center p-2 rounded-lg'>HandyMan Says: {error?.message.slice(17, -2) || gError?.message.slice(17, -2) || updateError?.message.slice(17, -2)}</p>
    }
    return (
        <div>
                        ...
                        <div className="flex flex-wrap items-center -mx-4">
                            <div className="w-full lg:w-1/2 px-4 mb-16 lg:mb-0">
                                <div className="max-w-md">
                                    ...
                                    <h2 className="mt-8 mb-12 text-3xl font-bold font-heading text-white">Welcome to HandyMan. Finish Signing Up here to continue further steps</h2>
                                </div>
                            </div>
