...
const SignUp = () => {
  ...
  const onSubmit = async (data) => {
    ...
    await updateProfile({
      ...
      photoURL: data.photoURL || "https://i.ibb.co/Q6nSX8P/logo.png",
    });
  };
  if (token) {
    signOut(auth);
  ...
  if (error || gError || updateError) {
    signInError = (
      <p className="text-red-400 text-center p-2 rounded-lg">
        HandyMan Says:{" "}
        {error?.message.slice(17, -2) ||
          gError?.message.slice(17, -2) ||
          updateError?.message.slice(17, -2)}
      </p>
    );
  }
  return (
            ...
            <div className="flex flex-wrap items-center -mx-4">
              <div className="w-full lg:w-1/2 px-4 mb-16 lg:mb-0">
                <div className="max-w-md">
                  ...
                  <h2 className="mt-8 mb-12 text-3xl font-bold font-heading text-white">
                    Welcome to HandyMan. Finish Signing Up here to continue
                    further steps
                  </h2>
                </div>
              </div>
                ...
                <div className="px-6 lg:px-20 py-12 lg:py-24 bg-gray-600 rounded-lg">
                  <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="flex items-center pl-6 mb-3 bg-white rounded-full">
                      ...
                      <input
                        ...
                        className="w-full pl-4 pr-6 py-4 font-bold placeholder-gray-900 rounded-r-full focus:outline-none"
                        type="email"
                        placeholder="johndoe@elitetoolboxes.com"
                      />
                    </div>
                    <p className="text-red-500 mb-1">
                    ...
                    <button className="py-4 w-full bg-blue-500 hover:bg-blue-600 text-white font-bold rounded-full transition duration-200">
                      {loading || updating ? <Loading /> : "Sign Up"}
                    </button>
                  </form>
                  ...
                  <div className="flex items-center justify-center">
                    <button
                      ...
                      className="flex items-center justify-center gap-3 border border-white p-2 rounded-3xl text-white"
                    >
                      <img
                  ...
                  <div className="relative flex py-1 items-center text-center justify-center">
                    <span className="flex-shrink mx-4 text-gray-400 text-center">
