...
const SignIn = () => {
    ...
    let signInError;
    if (error || gError) {
        signInError = <p className='text-white text-center bg-red-400 p-2 rounded-lg'>HandyMan Says: {error?.message.slice(17, -2) || gError?.message.slice(17, -2)}</p>
    }
                ...
                <div className="max-w-md w-full space-y-8">
                    <div>
                        <img
                            ...
                            src="https://i.ibb.co/jfC1qfJ/1600w-i-a-Xu-en-Vtw.webp"
                            alt="Workflow"
                        />
                        <h2 className="mt-6 text-center text-2xl font-extrabold text-gray-900">Sign in to your <span className='text-indigo-600'>HandyMan</span> account</h2>
                    </div>
